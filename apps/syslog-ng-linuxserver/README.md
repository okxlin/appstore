...
syslog-ng LinuxServer 使用 LinuxServer.io 维护的 `linuxserver/syslog-ng` 镜像，提供 syslog-ng 日志收集服务 能力。
...
syslog-ng LinuxServer uses the LinuxServer.io maintained `linuxserver/syslog-ng` image for Syslog collection.
