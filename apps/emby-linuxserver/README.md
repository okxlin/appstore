...
- 通过 Web UI 进行 media streaming 配置
- 持久化保存配置和业务数据
- 使用 8096 端口提供 Web 管理界面
- 支持自定义时区
...
- Expose the Web interface on port 8096
- Configure the container time zone

## Links

- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-emby/>
- Project website: <https://emby.media/>
