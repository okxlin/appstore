...
英文说明：Switch emulator desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：游戏。
- 支持架构：amd64。
- 可选版本：`latest`、`2026.02.1`。
...
## 参考资料
- 官网: <https://citron-emu.org/>
- 文档: <https://docs.linuxserver.io/deprecated_images/docker-citron/>
- 源码: <https://github.com/linuxserver/docker-citron>
