...
- 通过 Web UI 进行 Chromium browser desktop access 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-ungoogled-chromium/>
- Project website: <https://ungoogled-software.github.io/ungoogled-chromium-binaries/>
