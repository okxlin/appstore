...
英文说明：Image editor desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：媒体。
- 支持架构：amd64、arm64。
- 可选版本：`latest`、`6d0eb69a-ls136`。
...
- 文档: <https://docs.linuxserver.io/images/docker-gimp/>
- 源码: <https://github.com/linuxserver/docker-gimp>
