...
- 通过 Web UI 进行 RAW photo processing 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-rawtherapee/>
- Project website: <https://www.rawtherapee.com/>
