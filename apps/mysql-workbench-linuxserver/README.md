...
## 应用简介
MySQL Workbench 数据库桌面。

英文说明：Database administration desktop maintained by LinuxServer.io.
...
| TITLE | 浏览器页面标题 | MySQL Workbench | 否 |
...
- 文档: <https://docs.linuxserver.io/images/docker-mysql-workbench/>
- 源码: <https://github.com/linuxserver/docker-mysql-workbench>
