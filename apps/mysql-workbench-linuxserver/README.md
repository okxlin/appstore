...
- 通过 Web UI 进行 database administration 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-mysql-workbench/>
- Project website: <https://www.mysql.com/products/workbench/>
