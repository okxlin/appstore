...
## 应用简介
RPCS3 PlayStation 3 模拟器桌面。

英文说明：PlayStation 3 emulator desktop maintained by LinuxServer.io.
...
## 参考资料
- 官网: <https://rpcs3.net/>
- 文档: <https://docs.linuxserver.io/images/docker-rpcs3/>
- 源码: <https://github.com/linuxserver/docker-rpcs3>
