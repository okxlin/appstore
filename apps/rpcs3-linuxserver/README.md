...
RPCS3 使用 LinuxServer.io 维护的 `linuxserver/rpcs3` 镜像，提供 RPCS3 PlayStation 3 模拟器桌面 能力。
...
RPCS3 uses the LinuxServer.io maintained `linuxserver/rpcs3` image for PlayStation 3 emulation.
