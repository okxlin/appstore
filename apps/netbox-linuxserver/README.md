...
NetBox LinuxServer 使用 LinuxServer.io 维护的 `linuxserver/netbox` 镜像，提供 NetBox IPAM 与机房资产管理 能力。
...
NetBox LinuxServer uses the LinuxServer.io maintained `linuxserver/netbox` image for IPAM and data center infrastructure management.
