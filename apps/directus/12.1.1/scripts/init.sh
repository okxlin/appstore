...
mkdir -p -- "${DATA_DIR}"/{database,uploads,extensions}
chown 1000:1000 -- "${DATA_DIR}"/{database,uploads,extensions}

sync_secret DIRECTUS_SECRET "${DATA_DIR}/.directus-secret"
