...
Azahar 使用 LinuxServer.io 维护的 `linuxserver/azahar` 镜像，提供 Azahar Nintendo 3DS 模拟器桌面 能力。
...
Azahar uses the LinuxServer.io maintained `linuxserver/azahar` image for Nintendo 3DS emulation.
