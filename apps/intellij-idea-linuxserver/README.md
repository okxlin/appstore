...
- 通过 Web UI 进行 Java development 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-intellij-idea/>
- Project website: <https://www.jetbrains.com/idea/>
