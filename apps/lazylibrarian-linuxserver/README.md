...
- 通过 Web UI 进行 book library management 配置
- 持久化保存配置和业务数据
- 使用 5299 端口提供 Web 管理界面
- 支持自定义时区
...
- Expose the Web interface on port 5299
- Configure the container time zone

## Links

- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-lazylibrarian/>
- Project website: <https://lazylibrarian.gitlab.io/>
