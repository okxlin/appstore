...
WebCord 使用 LinuxServer.io 维护的 `linuxserver/webcord` 镜像，提供 WebCord Discord 客户端桌面 能力。
...
WebCord uses the LinuxServer.io maintained `linuxserver/webcord` image for Discord client access.
