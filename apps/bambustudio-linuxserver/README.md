...
- 通过 Web UI 进行 3D printing slicing 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-bambustudio/>
- Project website: <https://bambulab.com/en/download/studio>
