...
| 变量 | 说明 | 默认值 | 必填 |
| --- | --- | --- | --- |
| CHROME_CLI | 启动 URL | https://www.linuxserver.io/ | 否 |
| TIME_ZONE | 时区 | Asia/Shanghai | 是 |
| CUSTOM_USER | Basic Auth 用户名 | admin | 是 |
| PASSWORD | Basic Auth 密码 | 随机生成 | 是 |
| TITLE | 浏览器页面标题 | Chromium | 否 |
...
- 文档: <https://docs.linuxserver.io/images/docker-chromium/>
- 源码: <https://github.com/linuxserver/docker-chromium>
