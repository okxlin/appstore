...
## 应用简介
Flycast Dreamcast 模拟器桌面。

英文说明：Dreamcast emulator desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：游戏。
- 支持架构：amd64。
- 可选版本：`latest`、`2.6.20260621`。
...
## 参考资料
- 官网: <https://flyinghead.github.io/flycast-builds/>
- 文档: <https://docs.linuxserver.io/images/docker-flycast/>
- 源码: <https://github.com/linuxserver/docker-flycast>
