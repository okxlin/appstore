...
Ubooquity LinuxServer 使用 LinuxServer.io 维护的 `linuxserver/ubooquity` 镜像，提供 Ubooquity 电子书漫画服务 能力。
...
Ubooquity LinuxServer uses the LinuxServer.io maintained `linuxserver/ubooquity` image for ebook and comic library hosting.
