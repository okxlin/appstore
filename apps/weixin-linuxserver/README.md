...
英文说明：Weixin desktop client maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：工具。
- 支持架构：amd64、arm64。
- 可选版本：`latest`、`bc11f42c-ls30`。
...
- 文档: <https://docs.linuxserver.io/images/docker-weixin/>
- 源码: <https://github.com/linuxserver/docker-weixin>
