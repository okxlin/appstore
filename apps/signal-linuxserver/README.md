...
Signal 使用 LinuxServer.io 维护的 `linuxserver/signal` 镜像，提供 Signal 消息客户端桌面 能力。
...
Signal uses the LinuxServer.io maintained `linuxserver/signal` image for messaging.
