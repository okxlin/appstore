...
英文说明：Game emulator desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：游戏。
- 支持架构：amd64、arm64。
- 可选版本：`latest`、`2603a-ls71`。
...
## 参考资料
- 官网: <https://dolphin-emu.org/>
- 文档: <https://docs.linuxserver.io/images/docker-dolphin/>
- 源码: <https://github.com/linuxserver/docker-dolphin>
