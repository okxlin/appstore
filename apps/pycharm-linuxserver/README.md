...
## 应用简介
PyCharm Python IDE 桌面。

英文说明：Python IDE desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：Development。
- 支持架构：amd64。
- 可选版本：`latest`、`2026.1.2`。
...
- 文档: <https://docs.linuxserver.io/images/docker-pycharm/>
- 源码: <https://github.com/linuxserver/docker-pycharm>
