...
英文说明：Wolfenstein-inspired game desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：游戏。
- 支持架构：amd64。
- 可选版本：`latest`、`3.1.20260618`。
...
| TITLE | 浏览器页面标题 | Blade of Agony | 否 |
...
## 参考资料
- 官网: <https://boa.realm667.com/>
- 文档: <https://docs.linuxserver.io/images/docker-blade-of-agony/>
- 源码: <https://github.com/linuxserver/docker-blade-of-agony>
