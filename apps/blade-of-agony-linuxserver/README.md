...
- 通过 Web UI 进行 Wolfenstein-inspired gameplay 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-blade-of-agony/>
- Project website: <https://boa.realm667.com/>
