...
英文说明：A multi node frp webui (Console).
...
| 变量 | 说明 | 默认值 | 必填 |
| --- | --- | --- | --- |
| PANEL_APP_PORT_HTTP | 端口 (对应内部 9000) | 40195 | 是 |
| PANEL_APP_PORT_RPC | RPC 端口 (对应内部 9001) | 40196 | 是 |
...
| 变量 | 说明 | 默认值 | 必填 |
| --- | --- | --- | --- |
| APP_GLOBAL_SECRET | 通信密钥 | - | 是 |
| MASTER_RPC_HOST | RPC 监听 IP | 0.0.0.0 | 是 |
