...
英文说明：Kali Linux browser desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：安全。
- 支持架构：amd64、arm64。
- 可选版本：`latest`、`920d4a3a-ls118`。
...
- 文档: <https://docs.linuxserver.io/images/docker-kali-linux/>
- 源码: <https://github.com/linuxserver/docker-kali-linux>
