...
- 通过 Web UI 进行 GitHub workflow management 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-github-desktop/>
- Project website: <https://desktop.github.com/>
