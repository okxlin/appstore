...
- `Sandbox、Plugin Daemon 密钥`：安装时建议使用随机强密码。
...
PostgreSQL 15 is recommended. The package was tested with 1Panel PostgreSQL 15.18 and Redis for install, restart, and upgrade flows; PostgreSQL 18 is not recommended for Dify 1.15 migrations.
