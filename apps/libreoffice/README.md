...
英文说明：A free and powerful office suite.
...
| 变量 | 说明 | 默认值 | 必填 |
| --- | --- | --- | --- |
| PANEL_APP_PORT_HTTP | HTTP端口 | 40136 | 是 |
| PANEL_APP_PORT_HTTPS | HTTPS端口 | 40137 | 是 |
...
- 源码: <https://hub.docker.com/r/linuxserver/libreoffice>
