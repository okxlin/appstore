...
LDAP Auth LinuxServer 使用 LinuxServer.io 维护的 `linuxserver/ldap-auth` 镜像，提供 LDAP Auth 认证服务 能力。
...
LDAP Auth LinuxServer uses the LinuxServer.io maintained `linuxserver/ldap-auth` image for LDAP authentication proxy.
