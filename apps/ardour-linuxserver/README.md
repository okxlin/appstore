...
英文说明：Digital audio workstation desktop maintained by LinuxServer.io.

## 部署说明
- 本应用使用 Docker Compose 在 1Panel 中部署。
- 应用分类：媒体。
- 支持架构：amd64、arm64。
- 可选版本：`latest`、`2026-04-03-ls111`。
...
## 参考资料
- 官网: <https://ardour.org/>
- 文档: <https://docs.linuxserver.io/images/docker-ardour/>
- 源码: <https://github.com/linuxserver/docker-ardour>
