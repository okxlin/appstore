...
## 应用简介
Visual Studio Code 桌面开发环境。

英文说明：Code editor desktop maintained by LinuxServer.io.
...
| TITLE | 浏览器页面标题 | Visual Studio Code | 否 |
...
- 文档: <https://docs.linuxserver.io/images/docker-vscode/>
- 源码: <https://github.com/linuxserver/docker-vscode>
