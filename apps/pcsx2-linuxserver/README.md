...
## 应用简介
PCSX2 PlayStation 2 模拟器桌面。

英文说明：PlayStation 2 emulator desktop maintained by LinuxServer.io.
...
## 参考资料
- 官网: <https://pcsx2.net/>
- 文档: <https://docs.linuxserver.io/images/docker-pcsx2/>
- 源码: <https://github.com/linuxserver/docker-pcsx2>
