...
- 通过 Web UI 进行 Wine bottle management 配置
- 持久化保存配置和业务数据
...
- LinuxServer image documentation: <https://docs.linuxserver.io/images/docker-winegui/>
- Project website: <https://gitlab.melroy.org/melroy/winegui>
