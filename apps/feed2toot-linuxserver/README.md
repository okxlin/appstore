# Feed2toot LinuxServer

## 产品介绍

Feed2toot LinuxServer 使用 LinuxServer.io 维护的 `linuxserver/feed2toot` 镜像，提供 Feed2toot RSS 到 Mastodon 转发 能力。
...
Feed2toot LinuxServer uses the LinuxServer.io maintained `linuxserver/feed2toot` image for RSS to Mastodon posting.
