...
Luanti LinuxServer 使用 LinuxServer.io 维护的 `linuxserver/luanti` 镜像，提供 Luanti 沙盒游戏服务器 能力。
...
Luanti LinuxServer uses the LinuxServer.io maintained `linuxserver/luanti` image for Luanti game server.
